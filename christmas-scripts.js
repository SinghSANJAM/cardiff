document.addEventListener('DOMContentLoaded', () => {
    ...
    const momentDetails = {
      'wedding': {
        image: 'images/winter-wedding.jpg',
        details: 'There is something truly magical about a winter wedding. Whether you dream of a frosty fairytale or chic city celebration, our experienced team will help you craft an unforgettable day.'
      },
      'afternoon-tea': {
        image: 'images/afternoon-tea.jpg',
        details: 'Afternoon Tea at its most indulgent. Enjoy an exquisite selection of mini-desserts and bite-sized sandwiches.'
      }
    };
    ...
    document.querySelectorAll('.details-btn').forEach(button => {
      button.addEventListener('click', () => {
        ...
        modalTitle.textContent = moment === 'wedding' ? 'Festive Weddings' : 'Festive Afternoon Tea';
        modalImage.src = momentDetails[moment].image;
        modalImage.alt = `${moment === 'wedding' ? 'Festive Wedding' : 'Festive Afternoon Tea'} at Cardiff Holland House`;
